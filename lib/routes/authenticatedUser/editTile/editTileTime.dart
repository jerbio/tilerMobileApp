...
class _EditTileTimeState extends State<EditTileTime> {
  ...
  Widget build(BuildContext context) {
    ...
    final formattedTimeOfDay = localizations.formatTimeOfDay(TimeOfDay.fromDateTime(time));
      ...
      onTap: (){
        ...
        selectedTime.then((timeOfDayUpdate) {
          if(timeOfDayUpdate!=null) {
            DateTime updatedTime = DateTime(time.year, time.month, time.day, timeOfDayUpdate.hour, timeOfDayUpdate.minute);
