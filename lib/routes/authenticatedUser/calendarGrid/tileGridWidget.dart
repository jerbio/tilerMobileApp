...
class TileGridWidgetState extends GridPositionableState {
  ...
  void _recomputePosition() {
    ...
    if (dayStart == null) {
      ...
      final minPx = (TileGridWidgetState.minRenderedDurationMs(pxPerHour) /
  ...
  void _openEditFlow(BuildContext sheetContext, TilerEvent tile) {
    ...
    final SubCalendarEvent? subEvent = tile is SubCalendarEvent ? tile : null;
    ...
    final String tileId =
        (!tile.isFromTiler && thirdPartyId != null && thirdPartyId.isNotEmpty)
            ? thirdPartyId
            : (tile.id ?? "");
    Navigator.push(
      context,
