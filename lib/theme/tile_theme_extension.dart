...
class TileThemeExtension extends ThemeExtension<TileThemeExtension> {
  ...
  static TileThemeExtension get light => TileThemeExtension._(
        ...
        shadowPreviewChartIconographyOuter:
            TileColors.shadowPreviewChartIconographyOuterLight,
        ...
        shadowPreviewChartIconographyInner:
            TileColors.shadowPreviewChartIconographyInnerLight,
        ...
        onSurfaceMonthlyIntegration:
            TileColors.onSurfaceMonthlyIntegrationLight,
        ...
        statusSuccess: TileColors.statusSuccessLight,
        statusAttention: TileColors.statusAttentionLight,
        statusDanger: TileColors.statusDangerLight,
        ...
        suggestionLoadingOnboardingSurface:
            TileColors.suggestionLoadingOnboardingSurfaceLight,
        integrationApproval: TileColors.integrationApprovalLight,
        vibeChatModalBottomSheetHandle:
            TileColors.vibeChatModalBottomSheetHandleLight,
        ...
        vibeChatPreviewDisableColor:
            TileColors.vibeChatPreviewDisableColorLight,
        mapStyle: null,
      );
  ...
  static TileThemeExtension get dark => TileThemeExtension._(
        ...
        shadowPreviewChartIconographyOuter:
            TileColors.shadowPreviewChartIconographyOuterDark,
        ...
        shadowPreviewChartIconographyInner:
            TileColors.shadowPreviewChartIconographyInnerDark,
        ...
        statusSuccess: TileColors.statusSuccessDark,
        statusAttention: TileColors.statusAttentionDark,
        statusDanger: TileColors.statusDangerDark,
        ...
        suggestionLoadingOnboardingSurface:
            TileColors.suggestionLoadingOnboardingSurfaceDark,
        integrationApproval: TileColors.integrationApprovalDark,
        vibeChatModalBottomSheetHandle:
            TileColors.vibeChatModalBottomSheetHandleDark,
  ...
  ThemeExtension<TileThemeExtension> copyWith(
    ...
    return TileThemeExtension._(
        shadowPreviewChartIconographyOuter:
            shadowPreviewChartIconographyOuter ??
                this.shadowPreviewChartIconographyOuter,
        shadowSecondary: shadowSecondary ?? this.shadowSecondary,
        shadowMainInputContainer:
            shadowMainInputContainer ?? this.shadowMainInputContainer,
        shadowTimeScrubMovingBall:
            shadowTimeScrubMovingBall ?? this.shadowTimeScrubMovingBall,
        shadowEmptyTile: emptyTileShadow ?? this.shadowEmptyTile,
        shadowSignInContainer:
            shadowSignInContainer ?? this.shadowSignInContainer,
        shadowPreviewChartIconographyInner:
            shadowPreviewChartIconographyInner ??
                this.shadowPreviewChartIconographyInner,
        ...
        onSurfaceMonthlyIntegration:
            onSurfaceMonthlyIntegration ?? this.onSurfaceMonthlyIntegration,
        ...
        onSurfaceVariantSecondary:
            onSurfaceVariantSecondary ?? this.onSurfaceVariantSecondary,
        surfaceContainerGreater:
            surfaceContainerGreater ?? this.surfaceContainerGreater,
        surfaceContainerSuperior:
            surfaceContainerSuperior ?? this.surfaceContainerSuperior,
        surfaceContainerPlus: surfaceContainerPlus ?? this.surfaceContainerPlus,
        surfaceContainerMaximum:
            surfaceContainerMaximum ?? this.surfaceContainerMaximum,
        surfaceContainerUltimate:
            surfaceContainerUltimate ?? this.surfaceContainerUltimate,
        onSurfaceDeadlineUnset:
            onSurfaceDeadlineUnset ?? this.onSurfaceDeadlineUnset,
        onSurfaceTimeBlockLbl:
            onSurfaceTimeBlockLbl ?? this.onSurfaceTimeBlockLbl,
        surfaceContainerDisabled:
            surfaceContainerDisabled ?? this.surfaceContainerDisabled,
        darkPrimary: darkPrimary ?? this.darkPrimary,
        notificationOverlaySuccess:
            notificationOverlaySuccess ?? this.notificationOverlaySuccess,
        notificationOverlayWarning:
            notificationOverlayWarning ?? this.notificationOverlayWarning,
        notificationOverlayError:
            notificationOverlayError ?? this.notificationOverlayError,
        notificationOverlayInfo:
            notificationOverlayInfo ?? this.notificationOverlayInfo,
        ...
        disabledOnboardingPill:
            disabledOnboardingPill ?? this.disabledOnboardingPill,
        onDisabledOnboardingPill:
            onDisabledOnboardingPill ?? this.onDisabledOnboardingPill,
        suggestionLoadingOnboardingSurface:
            suggestionLoadingOnboardingSurface ??
                this.suggestionLoadingOnboardingSurface,
        integrationApproval: integrationApproval ?? this.integrationApproval,
        vibeChatModalBottomSheetHandle: vibeChatModalBottomSheetHandle ??
            this.vibeChatModalBottomSheetHandle,
        vibeChatExitedAction: vibeChatExitedAction ?? this.vibeChatExitedAction,
        vibeChatDisposedAction:
            vibeChatDisposedAction ?? this.vibeChatDisposedAction,
        vibeChatDefaultAction:
            vibeChatDefaultAction ?? this.vibeChatDefaultAction,
        vibeChatPreviewDisableColor:
            vibeChatPreviewDisableColor ?? this.vibeChatPreviewDisableColor,
        mapStyle: mapStyle ?? this.mapStyle);
  }

  @override
  ThemeExtension<TileThemeExtension> lerp(
      covariant ThemeExtension<TileThemeExtension>? other, double t) {
    if (other is! TileThemeExtension) {
      return this;
    }
    return TileThemeExtension._(
      shadowPreviewChartIconographyOuter: Color.lerp(
          shadowPreviewChartIconographyOuter,
          other.shadowPreviewChartIconographyOuter,
          t)!,
      shadowSecondary: Color.lerp(shadowSecondary, other.shadowSecondary, t)!,
      shadowMainInputContainer: Color.lerp(
          shadowMainInputContainer, other.shadowMainInputContainer, t)!,
      shadowTimeScrubMovingBall: Color.lerp(
          shadowTimeScrubMovingBall, other.shadowTimeScrubMovingBall, t)!,
      shadowEmptyTile: Color.lerp(shadowEmptyTile, other.shadowEmptyTile, t)!,
      shadowSignInContainer:
          Color.lerp(shadowSignInContainer, other.shadowSignInContainer, t)!,
      shadowPreviewChartIconographyInner: Color.lerp(
          shadowPreviewChartIconographyInner,
          other.shadowPreviewChartIconographyInner,
          t)!,
      shadowSearch: Color.lerp(shadowSearch, other.shadowSearch, t)!,
      onSurfaceDaySummary:
          Color.lerp(onSurfaceDaySummary, other.onSurfaceDaySummary, t)!,
      onSurfaceMonthlyIntegration: Color.lerp(
          onSurfaceMonthlyIntegration, other.onSurfaceMonthlyIntegration, t)!,
      primaryContainerLow:
          Color.lerp(primaryContainerLow, other.primaryContainerLow, t)!,
      onSurfaceHint: Color.lerp(onSurfaceHint, other.onSurfaceHint, t)!,
      onSurfaceSecondary:
          Color.lerp(onSurfaceSecondary, other.onSurfaceSecondary, t)!,
      onSurfaceVariantSecondary: Color.lerp(
          onSurfaceVariantSecondary, other.onSurfaceVariantSecondary, t)!,
      surfaceContainerGreater: Color.lerp(
          surfaceContainerGreater, other.surfaceContainerGreater, t)!,
      surfaceContainerSuperior: Color.lerp(
          surfaceContainerSuperior, other.surfaceContainerSuperior, t)!,
      surfaceContainerPlus:
          Color.lerp(surfaceContainerPlus, other.surfaceContainerPlus, t)!,
      surfaceContainerMaximum: Color.lerp(
          surfaceContainerMaximum, other.surfaceContainerMaximum, t)!,
      surfaceContainerUltimate: Color.lerp(
          surfaceContainerUltimate, other.surfaceContainerUltimate, t)!,
      onSurfaceDeadlineUnset:
          Color.lerp(onSurfaceDeadlineUnset, other.onSurfaceDeadlineUnset, t)!,
      onSurfaceTimeBlockLbl:
          Color.lerp(onSurfaceTimeBlockLbl, other.onSurfaceTimeBlockLbl, t)!,
      surfaceContainerDisabled: Color.lerp(
          surfaceContainerDisabled, other.surfaceContainerDisabled, t)!,
      darkPrimary: Color.lerp(darkPrimary, other.darkPrimary, t)!,
      notificationOverlaySuccess: Color.lerp(
          notificationOverlaySuccess, other.notificationOverlaySuccess, t)!,
      notificationOverlayWarning: Color.lerp(
          notificationOverlayWarning, other.notificationOverlayWarning, t)!,
      notificationOverlayError: Color.lerp(
          notificationOverlayError, other.notificationOverlayError, t)!,
      notificationOverlayInfo: Color.lerp(
          notificationOverlayInfo, other.notificationOverlayInfo, t)!,
      ...
      integrationBorder:
          Color.lerp(integrationBorder, other.integrationBorder, t)!,
      disabledOnboardingPill:
          Color.lerp(disabledOnboardingPill, other.disabledOnboardingPill, t)!,
      onDisabledOnboardingPill: Color.lerp(
          onDisabledOnboardingPill, other.onDisabledOnboardingPill, t)!,
      suggestionLoadingOnboardingSurface: Color.lerp(
          suggestionLoadingOnboardingSurface,
          other.suggestionLoadingOnboardingSurface,
          t)!,
      integrationApproval:
          Color.lerp(integrationApproval, other.integrationApproval, t)!,
      vibeChatModalBottomSheetHandle: Color.lerp(vibeChatModalBottomSheetHandle,
          other.vibeChatModalBottomSheetHandle, t)!,
      vibeChatExitedAction:
          Color.lerp(vibeChatExitedAction, other.vibeChatExitedAction, t)!,
      vibeChatDisposedAction:
          Color.lerp(vibeChatDisposedAction, other.vibeChatDisposedAction, t)!,
      vibeChatDefaultAction:
          Color.lerp(vibeChatDefaultAction, other.vibeChatDefaultAction, t)!,
      vibeChatPreviewDisableColor: Color.lerp(
          vibeChatPreviewDisableColor, other.vibeChatPreviewDisableColor, t)!,
