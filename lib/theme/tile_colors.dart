...
class TileColors {
  ...
  static final Color darkPrimary = HSLColor.fromColor(primary)
      .withLightness(HSLColor.fromColor(primary).lightness - 0.3)
      .toColor();
  ...
  static HSLColor primaryContainerDark =
      HSLColor.fromColor(primary).withLightness(0.22).withSaturation(0.30);
  static Color primaryContainerLowLight =
      primaryContainerLight.withLightness(0.95).toColor();
  static Color primaryContainerLowDark =
      primaryContainerDark.withLightness(0.35).toColor();
  ...
  static const Color shadowPreviewChartIconographyOuterLight =
      Color(0xFFDCDCDC);
  ...
  static final Color suggestionLoadingOnboardingSurfaceLight =
      Color(0xFFECD4A9);
  ...
  // Semantic status foregrounds, paired with the notificationOverlay* tints.
  // Use these instead of ad-hoc Colors.green/amber/red for on-track, needs
  // attention and late/conflict states anywhere in the app.
  static const Color statusSuccessLight = Color(0xFF05A86B);
  static const Color statusSuccessDark = Color(0xFF77CF86);
  static const Color statusAttentionLight = Color(0xFFF28A00);
  static const Color statusAttentionDark = Color(0xFFF8AF3C);
  static const Color statusDangerLight = Color(0xFFD92D20);
  ...
  static const String darkMapStyle =
      '''[{"elementType":"geometry","stylers":[{"color":"#212121"}]},{"elementType":"labels.text.fill","stylers":[{"color":"#757575"}]},{"elementType":"labels.text.stroke","stylers":[{"color":"#212121"}]},{"featureType":"road","elementType":"geometry","stylers":[{"color":"#2c2c2c"}]},{"featureType":"water","elementType":"geometry","stylers":[{"color":"#000000"}]}]''';
}
