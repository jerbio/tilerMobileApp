...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get wakeUpTimeQuestion => '通常、朝は何時に起きますか？';

  @override
  String get workdayStartQuestion => '通常、仕事は何時からですか？';
  ...
  @override
  String get timeAndLocationTitle => '時間と場所';

  @override
  String get timeAndLocationSubTitle => '現在どこにいますか？\n向こうの時間は何時ですか？';
  ...
  @override
  String get workProfileQuestion => '普段の1日の過ごし方は？仕事時間を設定してください';

  @override
  String get personalProfileQuestion => '週の間の「自分の時間」について教えてください';

  @override
  String get grabACoffee => 'コーヒーを飲む';

  @override
  String get recurringTasks => '繰り返しのタスク';

  @override
  String get recurringTasksQuestion => 'Tilerでスケジュールしたい定期タスクやアクティビティはありますか？';
  ...
  String get tileSuggestionsQuestion =>
      'ルーティンに合ったタイルを選び、Tilerにスケジュールを最適化させましょう';

  @override
  String get tileProfiling => 'Tilerがあなたの好みに基づいてプロファイリング中です…';

  @override
  String get addPlus => '追加 +';

  @override
  String get personalScheduling => '個人スケジュール';

  @override
  String get workPlanning => '業務計画';

  @override
  String get teamCoordination => 'チーム連携';

  @override
  String get fieldBaseCoordination => 'フィールドベースの連携';

  @override
  String get academicScheduling => '学業スケジュール';

  @override
  String get clientManagement => '顧客管理';

  @override
  String get personalOrWork => '個人的な利用ですか、業務ですか？';
  ...
  @override
  String get tilesVsBlocks => 'タイルとブロック';

  @override
  String get vsTilesDescription =>
      'ワークアウトや締切などの\n柔軟性のないイベントには、自動生成される\nタイルが利用できます。';

  @override
  String get vsBlocksDescription =>
      'ブロックは、特定の日時に行わなければならない重要なタイルのために予約する固定された時間です。';
  ...
  String get googleCalendarAndMoreDescription =>
      'カレンダーを同期して、Tilerがすべてを\n1つのスマートなタイムラインに集約します。\n重複予約もストレスもなし';

  @override
  String get selectSuggestions => '候補を選択';

  @override
  String get typeSomething => 'ここに何か入力してください';
