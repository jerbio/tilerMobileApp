...
class WeeklyPickerDialog extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  '${DateFormat('d MMM').format(state.tempSelectedWeek.first)} - ${DateFormat('d MMM').format(state.tempSelectedWeek.last)}',
              ...
              TableCalendar(
                ...
                selectedDayPredicate: (day) =>
                    (state.tempSelectedWeek).any((d) => isSameDay(d, day)),
                onDaySelected: (selectedDay, _) {
                  DateTime selectedDate = Utility.getWeekSunday(selectedDay);
                  context
                      .read<WeeklyUiDateManagerBloc>()
                      .add(SetTempSelectedWeek(selectedDate: selectedDate));
                },
                onPageChanged: (focusedDay) {
                  context
                      .read<WeeklyUiDateManagerBloc>()
                      .add(UpdateTempDate(tempDate: focusedDay.dayDate));
                },
  ...
  Widget _buildMonthYearPicker(
      BuildContext context, WeeklyUiDateManagerState state) {
    return Padding(
  ...
  Future<void> _selectYear(BuildContext context) async {
          ...
          content: Container(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                int displayedYear = Utility.currentTime().year - 5 + index;
    ...
    if (selectedYear != null && selectedYear != state.tempDate.year) {
      bloc.add(UpdateTempDate(
          tempDate: DateTime(selectedYear, state.tempDate.month).dayDate));
    }
  }
}
