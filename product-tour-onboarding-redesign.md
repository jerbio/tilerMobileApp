...
stage 3.5 (schedule prefetch during onboarding) followed. Next stage:
**4.1 — Local-only gate + call sites** (write `test/onboarding_gate_test.dart`
RED first; switch the 6 `signInComponent` sites to `primeScheduleAfterLogin`
while there).
