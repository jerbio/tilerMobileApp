...
> Status: **Design locked (all §10 decisions settled) / P1 complete (Steps 1.1–1.8); P2 complete (Steps 2.1–2.4); P3 Step 3.1 complete (travel bands, `a269b88` + `c95123f`); P4 drag-and-drop not started**
